...
This document collects practical profiles and diagnostics for tuning Remote WebView on ESP32 panels. The current stable render path is JPEG tiles over WebSocket.
...
| PNG | Planned | Planned | Not selectable yet. |
...
Future diagnostics work will add changed-tile colors, heatmaps, touch markers and runtime render mode controls.
