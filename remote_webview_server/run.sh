...
export RENDER_MODE="$(get_opt render_mode "jpeg")"
export MAX_BYTES_PER_MESSAGE="$(get_opt max_bytes_per_message 61440)"
export ADAPTIVE_QUALITY_ENABLED="$(get_opt adaptive_quality_enabled true)"
export ADAPTIVE_MIN_JPEG_QUALITY="$(get_opt adaptive_min_jpeg_quality 35)"
export ADAPTIVE_QUALITY_STEP="$(get_opt adaptive_quality_step 10)"
export ADAPTIVE_SPLIT_ENABLED="$(get_opt adaptive_split_enabled true)"
export ADAPTIVE_SPLIT_MIN_TILE_SIZE="$(get_opt adaptive_split_min_tile_size 16)"
